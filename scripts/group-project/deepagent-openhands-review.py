...
import git
# Import your tool
from custom_tool_template import TesslScanTool
...
if __name__ == "__main__":
    ...
    analysis_task = "Give me a summary and security considerations for the AI skills. Use the tessl_scanner tool to scan the skills directory at './repo/skills',"
